...
QBScoreboard.Open = function(data) {
    ...
    $.each(data.requiredCops, function(i, category){
        ...
        if (category.busy) {
            ...
            $(status).html('<i class="fas fa-eye green"></i>');
            $(status1).html('<i class="fas fa-eye green"></i>');
        } else {
            $(status).html('<i class="fas fa-eye-slash red"></i>');
            $(status1).html('<i class="fas fa-eye-slash red"></i>');
        }
